...
define('SECRET_SALT','d98fe4978b23a05308c32032c8e57269');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','admin@ticketingsystem.kamikazeinnovations.co.za');
...
define('DBNAME','kamikopi_ostic45');
define('DBUSER','kamikopi_ostic45');
define('DBPASS','T7U42!Slp!');

# Table prefix
define('TABLE_PREFIX','ostm6_');
