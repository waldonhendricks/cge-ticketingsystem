...
<div class="cover"> <div class="container"> <div class="row">
<div class="table-cover clearfix">
<div class="col-md-12">

<div class="row">
<div class="ts-cover clearfix">
        <form action="tickets.php" method="get" id="ticketSearchForm">
            <!-- Search form -->
            <div class="col-md-6">
                <div class="row">
                <input type="hidden" name="a"  value="search">
                <div class="col-sm-8"><input class="form-control" type="text" name="keywords" size="30" value="<?php echo Format::htmlchars($settings['keywords']); ?>"></div>
                <div class="col-sm-4"><input class="btn submit" type="submit" value="<?php echo __('Search');?>"></div>
                </div>
            </div>
            <!-- Help topics select -->
            <div class="col-md-6">
                <?php //echo __('Help Topic'); ?>
                <select class="form-control" name="topic_id" class="nowarn" onchange="javascript: this.form.submit(); ">
...
<table class="table table-bordered" id="ticketTable" border="0" cellspacing="0" cellpadding="0">
...
<?php
if ($total) {
    echo '<div class="paginate">&nbsp;'.__('Page').':'.$pageNav->getPageLinks().'&nbsp;</div>';
}
?>
</div></div>
 </div>
